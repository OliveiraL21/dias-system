...
const routes: Routes = [
  ...
  { path: 'login', loadChildren: () => import('./src/pages/login/login.module').then((m) => m.LoginModule) },
  { path: 'novo-usuario', loadChildren: () => import('./src/pages/novo-usuario/novo-usuario.module').then((m) => m.NovoUsuarioModule) },
  { path: 'esqueceu-senha', loadChildren: () => import("./src/pages/esqueceu-senha/esqueceu-senha.module").then((m) => m.EsqueceuSenhaModule) },
